    ...
    <div class="page-content">
        ...
        <div class="page-header">
            <div class="list-inline-item">
                <h2 class="h5 no-margin-bottom" ><a href="addCrypto"></a></h2>
            </div>
            <div class="list-inline-item">
                        ...
                        <div class="block">
                            ...
                            <div class="block-body">
                                <form:form action="cryptoSuccess" class="form-horizontal" method="post" modelAttribute="ownedcryptocurrencies">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-3 form-control-label" for="numOfCoins">Amount of crypto</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-9 ml-auto">
                                            <a href="<c:url value="/yourCrypto"/>" class="btn btn-secondary">Cancel</a>
