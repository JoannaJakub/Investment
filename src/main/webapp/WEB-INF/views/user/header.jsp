            ...
            <div class="right-menu list-inline no-margin-bottom">
                ...
                <div class="list-inline-item dropdown"><a id="navbarDropdownMenuLink1" href="#" data-toggle="dropdown"
                    ...
                    <div aria-labelledby="navbarDropdownMenuLink1" class="dropdown-menu messages"><a href="#"
                                                                                                     class="dropdown-item messanger d-flex align-items-center">
                    ...
                    </a><a href="#" class="dropdown-item messanger d-flex align-items-center">
                    ...
                    </a><a href="#" class="dropdown-item text-center messanger"> <strong>See All Messages <i
