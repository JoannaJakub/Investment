    ...
    <nav class="navbar navbar-expand-lg">
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
            ...
            <div class="right-menu list-inline no-margin-bottom">
                ...
                <!-- Log out               -->
                <div class="list-inline-item logout">  <a id="logout" href="/" class="nav-link"> <span class="d-none d-sm-inline">Logout </span><i class="icon-logout"></i></a></div>
            </div>
        </div>
    </nav>
</header>
<div class="d-flex align-items-stretch">
    ...
    <nav id="sidebar">
        ...
        <div class="sidebar-header d-flex align-items-center">
            <div class="avatar"><img src="resources/distribution/img/avatar-6.jpg" alt="..." class="img-fluid rounded-circle"></div>
            <div class="title">
        ...
        <ul class="list-unstyled">
            ...
            <li><a href="tables.html"> <i class="icon-grid"></i>Your stocks </a></li>
            <li><a href="charts.html"> <i class="fa fa-bar-chart"></i>Your crypto </a></li>
            <li><a href="forms.html"> <i class="icon-padnote"></i>Storage </a></li>
            <li><a href="forms.html"> <i class="icon-padnote"></i>All stocks </a></li>
            <li><a href="forms.html"> <i class="icon-padnote"></i>All crypto </a></li>
    ...
    <div class="page-content">
        ...
        <div class="container-fluid">
            <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Twoje inwestycje</a></li>
            </ul>
        </div>
