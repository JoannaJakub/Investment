                    ...
                    <div class="col-lg-12">
                        <div class="block">
                            ...
                            <div class="block-body">
                                <form:form action="stocksSuccess" class="form-horizontal" method="post" modelAttribute="ownedcryptocurrencies">
                                  <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-3 form-control-label" for="numOfCoins">Number of coins</label>
                                        <div class="col-sm-9">
