...
public class AdminUsersInvestExcelExporter {
    ...
    public AdminUsersInvestExcelExporter(List<Ownedcryptocurrencies> ownedcrypto, List<Ownedstocks> ownedstocks) {
    ...
    private void writeHeaderLine() {
        ...
        createCell(row, 5, "INVESTMENT ID", style);
    ...
    private void writeDataLines() {
        ...
        for (Ownedstocks ownedstocks : ownedstocks) {
            Row row = sheet.createRow(rowCount++);
            int columnCount = 0;
